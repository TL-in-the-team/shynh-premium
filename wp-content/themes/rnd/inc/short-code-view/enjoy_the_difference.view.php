...
<div id="enjoy-the-difference__slider" class="enjoy-the-difference__slider owl-carousel owl-theme">
  ...
  <div class="enjoy-the-difference__item">
    <img src="<?php echo imageEncodeURL($url);?>" height="<?php echo $height ?>" width="<?php echo $width?>" title="<?php echo $title?>" alt="<?php echo $alt?>" class="enjoy-the-difference__item__img">
  </div>
  <?php 
    endwhile;
  ?>
